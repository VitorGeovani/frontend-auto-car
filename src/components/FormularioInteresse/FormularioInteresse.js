    ...
    return (
      <Card className="interesse-card success-card">
        <Card.Body className="texto-confirmacao">
          ...
          <p>Recebemos seu interesse no veículo. Nossa equipe entrará em contato em breve!</p>
          <Button 
            variant="success" 
      ...
      <Card.Body>
        ...
        <Form onSubmit={handleSubmit} className="form-compact">
          <Form.Group className="form-group">
            <Form.Label><FaUser className="icon-label" /> Nome*</Form.Label>
            <Form.Control
              type="text"
              name="nome"
              value={formData.nome}
          ...
          <Form.Group className="form-group">
            <Form.Label><FaEnvelope className="icon-label" /> E-mail*</Form.Label>
            <Form.Control
              type="email"
              name="email"
          ...
          <Form.Group className="form-group">
            <Form.Label><FaPhone className="icon-label" /> Telefone*</Form.Label>
            <Form.Control
              type="tel"
              name="telefone"
          ...
          <Form.Group className="form-group">
            <Form.Label><FaCommentAlt className="icon-label" /> Mensagem</Form.Label>
            <Form.Control
              as="textarea"
              rows={6}
              name="mensagem"
