            ...
            {vehicles.map(vehicle => (
              <tr key={vehicle.id}>
                ...
                <td className="actions">
                  <Link to={`/admin/veiculos/${vehicle.id}`} className="btn btn-sm btn-info me-2">
                    <FaEye /> Ver
                  </Link>
                  <Link to={`/admin/veiculos/editar/${vehicle.id}`} className="btn btn-sm btn-warning me-2">
                    <FaEdit /> Editar
                  </Link>
                  <Button variant="danger" size="sm" onClick={() => handleDelete(vehicle.id)}>
                    <FaTrash /> Excluir
                  </Button>
                </td>
              </tr>
