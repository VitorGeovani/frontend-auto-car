...
import { FaArrowLeft, FaCalendarAlt, FaTachometerAlt, FaGasPump, 
         FaMoneyBillWave, FaCarSide, FaInfoCircle } from 'react-icons/fa';
    ...
    <div className="interesse-page">
      <Container>
        <div className="page-header">
          <h2><FaCarSide className="me-2" /> Demonstrar interesse</h2>
            ...
            <Card className="veiculo-card">
              ...
              <Card.Body>
                ...
                <div className="veiculo-badges">
                  ...
                  <Badge bg="light" text="dark">
                    <FaTachometerAlt /> {veiculo.quilometragem?.toLocaleString() || 0} km
                  </Badge>
                  <Badge bg="light" text="dark">
